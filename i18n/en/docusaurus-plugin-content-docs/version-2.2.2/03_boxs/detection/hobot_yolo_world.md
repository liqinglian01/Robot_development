...
```bash
# Configure the tros.b environmentsource /opt/tros/humble/setup.bash
```
...
# Launch the launch fileros2 launch hobot_yolo_world yolo_world.launch.py yolo_world_texts:="red bottle,trash bin"
```
...
# Download and extract the modelwget http://archive.d-robotics.cc/models/yoloworld_encode_text/huggingclip_text_encode.tar.gz
