...
```bash
# Configure the TogetheROS.Bot environmentsource /opt/tros/setup.bash
```
...
# Configure the TogetheROS.Bot environmentsource /opt/tros/humble/setup.bash
```
...
# Launch the exampleros2 launch trigger_node_example hobot_trigger_example.launch.py
```
...
```bash
# Set up the tros.b environmentsource /opt/tros/setup.bash
```
...
```bash
# Set up the tros.b environmentsource /opt/tros/humble/setup.bash
```
