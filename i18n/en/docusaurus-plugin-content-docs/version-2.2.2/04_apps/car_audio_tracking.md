...
1. Copy audio configuration files and load the audio driver
 ...
 <TabItem value="foxy" label="Foxy">
    ...
    ```bash
    # Set up the tros.b environment    source /opt/tros/setup.bash
    ```
 ...
 <TabItem value="humble" label="Humble">
    ...
    ```bash
    # Set up the tros.b environment    source /opt/tros/humble/setup.bash
    ```
...
Audio control command word definitions are:
        ...
        "Go backward"
        "Turn right"
        "Turn left" When you say the wake word, the car turns toward you 
