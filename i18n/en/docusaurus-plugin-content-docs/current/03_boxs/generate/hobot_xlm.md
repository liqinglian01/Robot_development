...
# config contains example model configuration filescp -r /opt/tros/humble/lib/hobot_xlm/config/ .
...
1. Launch `hobot_llm`:
    ...
    lib=/opt/tros/humble/lib/hobot_xlm/lib
    export LD_LIBRARY_PATH=${lib}:${LD_LIBRARY_PATH}
    # config contains example model configuration files    cp -r /opt/tros/humble/lib/hobot_xlm/config/ .
