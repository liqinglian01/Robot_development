...
# Launch the launch fileros2 launch reid reid.launch.py
```
...
# Launch the launch fileros2 launch reid reid.launch.py publish_image_source:=config/person_body.jpg publish_image_format:=jpg publish_output_image_w:=1920 publish_output_image_h:=1080
```
